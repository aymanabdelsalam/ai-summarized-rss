...
def summarize_text_with_gemini(text_to_summarize, article_title="this article"):
    ...
    try:
        prompt = (
            f"لو سمحت، اعمل ملخص شامل بدون الاخلال عن مقصد ومحتوى المقاله الأصلى من كذا فقرة للمقالة الإخبارية دي بعنوان '{article_title}' باللهجة المصرية  العامية بدون الإشارة للمقالة الأصليه وكأنك بتكتب انت مقاله جديدة. "
            ...
            f"ابدأ المقالة بتحية مصرية سهله، زي مساء الفل أو صباح الفل حسب توقيت اعداد التلخيص بدون استخدام كلمة يا جدعان."
