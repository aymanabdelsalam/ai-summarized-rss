...
def summarize_text_with_gemini(text_to_summarize, article_title="this article"):
    ...
    try:
        prompt = (
            f"لخص المقال الإخباري التالي بالعامية المصرية"
f"​التعليمات:​ التركيز: ركز على الأحداث الرئيسية، الشخصيات المهمة، الأرقام التواريخ، والنتائج النهائية."
f"​التنظيم: قسم التلخيص في فقرات قصيرة، بحد أقصى 4 فقرات."
f"​الدقة: حافظ على كل المعلومات الجوهرية من المقال الأصلي بدون ما تفقد أي تفاصيل مهمة."
f"​الإيجاز: استخدم لغة بسيطة ومباشرة، وتجنب التكرار والحشو والكلام اللي مالوش لازمة."
f"​البحث الإضافي: لو احتجت، ابحث في مصادر خارجية عشان توضح خلفية الخبر أو تكمل أي معلومة ناقصة، بحيث يكون التلخيص شامل ومفهوم.\n\n:\n{text_to_summarize}"
        )
