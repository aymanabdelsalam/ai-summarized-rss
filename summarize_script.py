...
f"​التنظيم: قسم التلخيص في فقرات متوسطة، بحد أقصى 4 فقرات."
f"​الدقة: حافظ على كل المعلومات الجوهرية من المقال الأصلي بدون ما تفقد أي تفاصيل مهمة."
f"​الإيجاز: استخدم لغة بسيطة ومباشرة أقرب إلى الفصحى، وتجنب التكرار والحشو والكلام اللي مالوش لازمة."
